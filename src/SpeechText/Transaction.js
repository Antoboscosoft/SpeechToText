...
// import '../Assets/Stylesheets/Transaction.css';
...
function Transaction() {
    ...
    return (
        <div className='transaction vh-100 d-flex container '>
            <div className='header'>
                text
            </div>
            <div className='body main_content_actionpoint'>
                    ...
                    {activeTab === 'records' && (
                        ...
                        <div className='card'>
                            <div className='card-body'>
                                ...
                                <textarea placeholder='Speech to text here...' rows={10} className='form-control textInput mb-2 mt-1' value={transcript}
