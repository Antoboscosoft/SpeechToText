...
import '../Assets/Stylesheets/SpeechPOC.css';
...
function SpeechPOC() {
    ...
    const handleCopyAndSendToChatGPT = (e) => {
        ...
        console.log("LOG DATA :", e.target.value)
    };
    ...
    const chatBotCall = (userInput) => {
        console.log("chatbot out call", userInput);
        if (userInput.trim() !== '') {
            console.log("Chatbot in call");
            var last_index = chatMsg.length;
            console.log("msg", userInput, chatMsg);
            setChatMsg([...chatMsg, { usermsg: userInput, botmsg: 'Typing ......' }]);
            axios({
                method: 'post',
                // url: 'https://bot.quadnomics.in/chat', // Adjust the URL based on your chatbot API endpoint
            ...
            console.log("Chatbot error else thrown...");
        }
    };
    ...
    // Button click event for ChatGPT-Request
    const handleChatGPTRequest = (e) => {
        console.log("data chat :", e.target.value, transcript);
        // Assuming noteContent is the data you want to send to the chatbot
        chatBotCall(transcript);
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <div className='d-flex justify-content-evenly mt-2 allbuttons'>
                                        ...
                                        <div>
                                            <button className='btn icon_ChatSend' title='ChatGPT-Request'
                                                onClick={(e) => handleChatGPTRequest(e)}
                                            // onClick={handleCopyAndSendToChatGPT}
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" height="28" width={28} viewBox="0 0 512 512">
                                    ...
                                    <code className='fw-bold d-flex'>Chat-GPT Response:</code>{"chat value : " + chatGPTResponse}
